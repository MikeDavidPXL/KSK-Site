  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <h1 className="font-display text-4xl sm:text-6xl font-bold uppercase mb-4 text-primary">
          KSK
        </h1>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-display font-bold text-lg px-10 py-4 rounded-sm transition"
        >
