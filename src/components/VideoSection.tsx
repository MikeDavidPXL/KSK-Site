  ...
  return (
    <section id="video" className="py-24 relative">
      <div className="container mx-auto px-4" ref={ref}>
        <motion.h2
          className="font-display text-3xl sm:text-4xl font-bold uppercase mb-4 text-center text-primary"
        ...
        <motion.div
          className="max-w-4xl mx-auto rounded-sm overflow-hidden border border-border"
